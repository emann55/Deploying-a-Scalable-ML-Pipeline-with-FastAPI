...
app = FastAPI(
    ...
    description="Predicts whether your salary will be over 50,000 yearly, based on US Census data",
    version="1.0.0"
)
...
async def get_root():
    """ Say hello!"""
    return{"message": "Hello! Use the /data/ endpoint to make a prediction for salary!"}
